...
user.rooms.forEach(room => {
    ...
    document.getElementById(room.id).addEventListener('mousedown', (e) => {
        ...
        topBarChatBox.getElementsByTagName('img')[0].src = `/roomProfilePics/${room.id}.png`;
        ...
        roomDescription.getElementsByTagName('img')[0].src = `/roomProfilePics/${room.id}.png`;
            ...
            if( onlineUsers[member])
            {
                ...
                myUL.innerHTML +=  `<li id="${member}" class="list-group-item">
                                        <div class="img-cropper-small">
                                            <img src="/profilePics/${member}.png" alt="user">
                                        </div>
